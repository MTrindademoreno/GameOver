...
package com.marciotrindade.gameover.network
...
class Network(val context: Context) : LiveData<Boolean>(){
    ...
    class NetworkCallback(val liveData : com.marciotrindade.gameover.network.Network) : ConnectivityManager.NetworkCallback() {
